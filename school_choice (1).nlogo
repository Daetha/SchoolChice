...
to setup
  ...
  create-schools num-schools - (share-statused / 100) * num-schools [ ;; creating the exact share of unstatused schools
    set color 16
    set status 0
    set ege random-normal mean_ege_unstatused_schools 15
  ]
  create-schools (share-statused / 100) * num-schools [ ;; creating the exact share of statused schools
    set color 66
    set status 1
    set ege random-normal mean_ege_statused_schools 15
  ]
  ask schools [
  ...
  create-students num-students [
    ...
    set assigned FALSE
    set best-fit nobody
    (ifelse random 100 < share-ethnic-minority [ ;; the number of ethnic minority students will be about the stated share
      set ethnic-minority TRUE ] [ set ethnic-minority FALSE ]
    )
  ]
  reset-ticks
end
...
to go-once
  ...
  let searchers students with [ not assigned ]
  if any? searchers [
;    ask schools [
...
to apply
  ...
  (ifelse class = "middle" [
   ...
   ask turtles [
    ...
    class = "working" [
      ( ifelse ethnic-minority [
        set best-fit one-of potential-schools with [
          ege > 80 AND
          ethnic-share > 0.1 AND ethnic-share < 0.2
        ]
        ]
        [
          set best-fit one-of potential-schools with [
...
220
N minority students
count students with [ ethnic-minority ] * 100 / num-students
0
1
11
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "plot share-ethnic of [ schools ]"
